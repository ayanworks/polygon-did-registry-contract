...
let accounts, PolygonDIDRegistryInstance, PolygonDIDRegistryInstance_test;
...
describe('Basic Contract Testing', () => {
    ...
    describe('Setting up the contract', async () => {
        ...
        it('This Deploys Polygon Smart contract from 1st account with no Parameters/Constructor', async () => {
            ...
            PolygonDIDRegistryInstance_test = new ethers.Contract(PolygonDIDRegistryInstance.address, PolygonDIDRegistryJSON.abi, provider.getSigner(accounts[1]));
    ...
    //Describing test 5 to check if test fails if we update with different controller
